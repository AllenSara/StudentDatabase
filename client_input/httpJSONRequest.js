...
function httpJSONRequest(method, url, body = null) {
    ...
    It was tailored to:
      ...
      3) receive only (JSON) strings, not buffers
      4) return only the body (the payload) and not the HTTP headers

    At the bottom of this page, one can find examples the show how to use this module.
    */
    let urlObject;
...
Then, await the promise to be fulfilled and get the result that it returns:
